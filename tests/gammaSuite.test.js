...
describe('AR Web App', () => {
    ...
    describe("Psyche gamma-ray spectrometer visual representation", () => {
        test('Gamma-ray spectrometer model is rendered when selected', async () => {
    ...
    describe("Psyche gamma-ray spectrometer response", () => {
    ...
    describe("Psyche gamma-ray spectrometer webpage information ", () => {
        test('Details box is shown and correct description is displayed when selected', async () => {
            ...
            expect(titleText).toBe('Gamma Ray Spectrometer');
            ...
            expect(descriptionText).toBe('In Orbit D—the closest orbit—the gamma-ray spectrometer focuses on elemental mapping by detecting gamma-rays generated by cosmic-ray interactions with Psyche’s surface. This instrument identifies and quantifies key elements, such as iron and nickel, by analyzing the energy signatures of the emitted gamma-rays. This detailed compositional data is critical for understanding whether Psyche is the remnant core of a disrupted planetesimal or a unique metal-rich body\.');

        }, 10000);
    });

    describe("Gamma-ray spectrometer sample data", () => {
        test('Sample data box is shown and correct description is displayed when selected', async () => {
            ...
            expect(descriptionText).toBe('Figure 4, A. from (Peplowski Et. Al., 2022) shows a portion of the gamma-ray spectrum for high-purity Germanium\.');
